    ...
    <div className="relative w-full h-[90vh] overflow-hidden z-0">
      {images.map((img, idx) => (
        <img
          ...
          src={img}
          alt={`Slide ${idx + 1}`}
          className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-700 ${current === idx ? "opacity-100 z-0" : "opacity-0 z-0"}`}
        ...
        <div className="container mx-auto px-4 pb-32 w-full">
          <div className="flex items-center justify-between text-white mb-8">
            <div>
              ...
              <p className="text-sm font-medium my-2">Combine Quality with Morality</p>
            </div>
