...
const notices = [
  { date: "20", month: "JUN", text: "Pre-requisites to Sit for Semester End Exam. Spring-2025" },
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col gap-4 mb-4">
            {notices.map((notice, idx) => (
              <div key={idx} className="flex items-center gap-4 border-b border-[#D9E5DD] pb-4">
                <div className="flex flex-col items-center justify-center w-12">
                  <span className="text-xl font-bold text-[#005C25]">{notice.date}</span>
                  <span className="text-xs font-semibold text-[#005C25]">{notice.month}</span>
                </div>
                <span className="text-base text-[#222]">{notice.text}</span>
              </div>
            ))}
          </div>
          <a href="#" className="text-[#005C25] font-semibold flex items-center gap-1 hover:underline mt-2">
        ...
        <div className="flex-1 flex flex-col h-full">
          ...
          <div className="bg-white rounded-xl shadow p-4 flex flex-col h-full">
            ...
            <div className="font-semibold text-lg mb-2 text-[#222]">
              International Conference on Islamic Universities and their Contemporary Challenges (ICIUCC)
            </div>
            <a href="#" className="text-[#005C25] font-semibold flex items-center gap-1 hover:underline mt-auto">
